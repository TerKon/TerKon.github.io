<div id="navigation">
	<div id="main-nav">
		<ul class="tabbed">
			<li><a class="main-nav_a" id="#menu_1">{"_ADMINAREA"|lang}</a></li>
			<li><a class="main-nav_a" id="#menu_2">{"_SERVER"|lang}</a></li>
			<li><a class="main-nav_a" id="#menu_3">{"_WEB"|lang}</a></li>
			<li><a class="main-nav_a" id="#menu_4">{"_MODULES"|lang}</a></li>
		</ul>
	...
	<div id="sub-nav">
		...
		<div id="menu_4" style="{if $menu_pos == "so_mo" || $menu_pos == "iexport"}display: block;{else}display: none;{/if}">
			<ul class="tabbed">
